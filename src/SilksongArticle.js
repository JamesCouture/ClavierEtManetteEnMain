    ...
    return (
        <div className="silksongarticle">
            ...
            <div className="content" style={{justifyContent:'center',display:"flex"}}>
                ...
                {/* <iframe
                    src="https://youtu.be/JSfuFlhsxZY"
                    frameborder="0"
            ...
            <div>
                <h4><br /><br /><br />Disclaimer: Ces paragraphes ont été prix du site web suivant "https://www.gameblog.fr/jeu-video/ed/news/hollow-knight-silksong-prepare-une-enorme-surprise-sur-xbox-402444", utilisé pour démontrer le site web.</h4>
            </div>
        </div>
    );
}
